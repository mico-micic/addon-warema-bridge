...
console.log(`-----------------------------------------`)
console.log(`WMS channel: ${settingsPar.wmsChannel}`)
console.log(`WMS key: ${settingsPar.wmsKey}`)
console.log(`WMS pan id: ${settingsPar.wmsPanid}`)
console.log(`WMS srial port: ${settingsPar.wmsSerialPort}`)
